...
# todo add examples of lise as well, to sm_mg as well
def main_example_sm_oi():
    """
    Code example for using cdfs modelled using integrated signal model, hence sm, and optimum interval method, hence oi.
