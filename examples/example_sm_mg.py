...
def main_example_sm_mg_1():
    """
    Code example for limit calculation using cdfs modelled using integrated signal model, hence sm, and maximum gap
    method, hence mg.
...
if __name__ == '__main__':
    main_example_sm_mg_1()
    main_example_sm_mg_2()
